...
uv run python fine_tune_qwen.py --output_dir "$TEACHER_DIR" --model_id "$TEACHER_BASE_MODEL"
...
uv run python eval_qwen.py --model_dir "$STUDENT_DIR" --output_dir "$STUDENT_EVAL_DIR" --base_model_id "$STUDENT_BASE_MODEL"
